# Části třetí a čtvrtá — Daň ze staveb a jednotek; výpočet daně (§§ 7–11e)

> **Téma kapitoly:** Třetí část zákona č. 338/1992 Sb. buduje kompletní základ pro zdanění **zdanitelných staveb a zdanitelných jednotek** — od vymezení předmětu daně a okruhu poplatníků přes katalog osvobození až ke stanovení základu daně (zastavěná plocha u staveb, upravená podlahová plocha u jednotek) a sazbám daně diferencovaným podle skupin staveb a jednotek (§ 10a), koeficientu podle počtu nadzemních podlaží a koeficientu podle velikosti obce. Část čtvrtá (§§ 11b–11e) pak uzavírá algoritmický cyklus výpočtu daně: stanoví instituci výpočtového listu, postup výpočtu výchozích daní z pozemků i ze staveb a jednotek (včetně inflačního koeficientu a spoluvlastnického podílu) a celkové daně z nemovitých věcí jako součtu obou složek. Na obecná a společná ustanovení odkazuje [01-casti1-2-obecna-dan-z-pozemku.md](01-casti1-2-obecna-dan-z-pozemku.md); ustanovení o správě daně, daňovém přiznání a placení pokrývá [03-casti5-6-spolecna-sprava-dane.md](03-casti5-6-spolecna-sprava-dane.md).
...
#### Zdanitelná stavba (odst. 1 písm. a)

Zákon rozlišuje dva typy zdanitelných staveb:

1. **Budova** — vymezena odkazem na katastrální zákon (zákon č. 256/2013 Sb.): budovou se rozumí nadzemní stavba spojená se zemí pevným základem, která je prostorově soustředěna a navenek uzavřena obvodovými stěnami a střešní konstrukcí. Pro daňové účely se nevyžaduje zápis v katastru nemovitostí; rozhodující je faktická existence stavby.

2. **Inženýrská stavba** — pouze ta, která je **výslovně uvedena v příloze k zákonu**. Příloha vymezuje taxativní výčet inženýrských staveb podle klasifikace CZ-CC; jde zejména o věže pro vysílání a retranslační věže (ex 221341), věže a věžové zásobníky pro hornictví (230141), chladící věže pro energetiku (230241), komíny pro energetiku (ex 230251), věže a věžové zásobníky chemických podniků (ex 230341), průmyslové komíny chemických podniků (230351), vysoké pece (ex 230411), věže a věžové zásobníky pro ostatní průmysl (230441) a průmyslové komíny pro ostatní průmysl (230451). Kód označený předponou „ex" omezuje rozsah na inženýrské stavby popsané slovním opisem; rozsah bez předpony „ex" zahrnuje celou skupinu CZ-CC.

Obě kategorie musí být **dokončené nebo užívané** — tento požadavek brání zdanění nedokončených staveb, jejichž provoz ještě nezačal. Klíčová je alternativa: i stavba formálně nedokončená, je-li fakticky užívána, se stává předmětem daně.

#### Zdanitelná jednotka (odst. 1 písm. b)

Zdanitelnou jednotkou je **jednotka dokončená nebo užívaná**. Pojmem „jednotka" zákon odkazuje na jednotku ve smyslu občanského zákoníku (§ 1159 a násl. zákona č. 89/2012 Sb.). § 12b zákona pak rozšiřuje výklad i na jednotky vymezené podle zákona č. 72/1994 Sb. (zákon o vlastnictví bytů), tj. na tzv. „staré" jednotky vzniklé za předchozí právní úpravy.

#### Vyloučení dvojího zdanění (odst. 2)

Odstavec 2 brání **souběžnému zdanění** téže nemovité věci jak jako zdanitelné stavby, tak jako zdanitelných jednotek v ní obsažených: je-li budova členěna na zdanitelné jednotky, přestává být sama předmětem daně jako stavba a daní se pouze jednotlivé jednotky. Tím je vyloučena kaskáda zdanění.

#### Stavba jako součást pozemku (odst. 3)

Připomíná se vazba na zásadu superficies solo cedit: zdanitelná stavba, která není samostatnou nemovitou věcí (tj. je součástí pozemku), se přesto pro daňové účely považuje za samostatnou nemovitou věc, jejímž vlastníkem je vlastník pozemku. Tím se zachovává zdanitelnost i u staveb, které soukromoprávně splynuly s pozemkem.

#### Části a součásti (odst. 4)
...
Daňová povinnost je primárně svázána s **vlastnickým právem**. Poplatníkem je ten, kdo je zapsán jako vlastník v katastru nemovitostí, popřípadě ten, kdo vlastnické právo nabyl a dosud nedošlo k zápisu (§ 7 odst. 1 katastrálního zákona — vkladem). Vztah ke zdanitelné stavbě, která není evidována v katastru (§ 7 odst. 3 zákona), se odvíjí od vlastnictví věci, jejíž je stavba součástí.

#### Státní nemovitosti — příslušnost k hospodaření (odst. 2 písm. a)

Stát jako vlastník neplatí sám za sebe (prostřednictvím státní pokladny), ale daňová povinnost přechází na subjekt, který je příslušný hospodařit s danou nemovitou věcí. Zákon vyjmenovává organizační složky státu, státní příspěvkové organizace, státní fondy, státní podniky a jiné státní organizace. Výjimečně může být poplatníkem i soukromoprávní právnická osoba, která nemovitost užívá na základě výpůjčky vzniklé podle zákona č. 219/2000 Sb. (zákon o majetku ČR a jejím vystupování v právních vztazích).

#### Fondy (odst. 2 písm. b–d)

Svěřenský fond, podílový fond a fond obhospodařovaný penzijní společností nejsou právnickými osobami, přesto zákon konstruuje jejich daňovou způsobilost jako poplatníků. Jde o technické řešení, které zabraňuje mezeře ve zdanění: bez tohoto pravidla by bylo obtížné určit, kdo je poplatníkem za majetek v těchto strukturách.

#### Správa státních hmotných rezerv a privatizace (odst. 3)

V těchto dvou specifických situacích se poplatníkem stává **nájemce nebo pachtýř**, a to bez ohledu na vlastnictví. Smyslem je přenést daňovou zátěž na toho, kdo nemovitost fakticky využívá, když hospodaření s ní vykonávají zvláštní orgány státu.
...
| Titul | Stručný popis | Odst. 1 |
|---|---|---|
| a) | Vlastnictví ČR | abs. |
| b) | Vlastnictví obce na jejím území | abs. |
| c) | Cizí státy — diplomati, konzulové | vzájemnost |
| d) | Kulturní památky veřejně přístupné | smlouva s MK |
| e) | Registrované církve a náboženské společnosti | ne podnikání |
| f) | OPS, spolky, odborové org., org. zaměstnavatelů | ne podnikání |
| g) | Přenosové/distribuční soustavy, rozvodné tepelné zař. | abs. |
| i) | Vodárenské, kanalizační stavby, závlahy | abs. / celá stavba |
| j) | Stavby drah, letecké, vodních cest — veřejná doprava | podmínka užívání |
| k) | Školy, muzea, knihovny, archivy, zdravotnictví, soc. služby | taxativní výčet |
| l) | Hromadná osobní přeprava | abs. |
| m) | Obnovitelné zdroje energie, asanace, MVE | výlučnost |
| n) | ZTP/ZTP/P — obytné domy (trvalé bydlení) | rozsah bydlení |
| o) | ZTP/ZTP/P — rekreační budovy | typ průkazu |
| p) | Kulturní památky po stavební úpravě | 8 let, kolaudace |
| r) | Změna vytápění na OZE | 5 let, ne CZT |
| t) | Vlastnictví kraje v jeho obvodu | abs. |
| u) | Veřejné výzkumné instituce | ne podnikání/nájem |
| v) | Veřejné vysoké školy | ne podnikání/nájem |
| w) | Zvýhodněné průmyslové zóny | max. 5 let, OZV |

#### Podmínky nároku a jeho uplatnění (odst. 4–5)

Zákon u řady titulů osvobozování podmiňuje negativní podmínkou: stavba ani jednotka **nesmí být užívána k podnikání, pronajata ani propachtována**. U titulu písm. a) (státní nemovitosti s nebytovým prostorem) existuje výjimka — pronájem obci, kraji, organizační složce státu nebo příspěvkové organizaci není na závadu, pokud nemovitost není užívána k podnikání. Osvobození podle písm. r) (přechod na OZE) se nevztahuje na stavby napojené na systém centrálního zásobování teplem (CZT).

Zákonodárce pro část titulů (d) až f), k), m) až r), u), v)) požaduje **aktivní uplatnění nároku v daňovém přiznání**. Ostatní tituly (a–c, g, i, j, l, t, w) správce daně zohlední z úřední povinnosti.

#### Proporcionalita osvobození (odst. 2–3)
...
Základ daně u stavby je plošný — odpovídá **výměře zastavěné plochy v m² odpovídající nadzemní části zdanitelné stavby** ke stavu k 1. lednu zdaňovacího období. Odst. 2 vymezuje zastavěnou plochu odkazem na stavební zákon: jde o plochu ohraničenou pravoúhlými průměty vnějšího líce svislých konstrukcí nadzemních podlaží do vodorovné roviny. Podzemní části stavby (suterény, sklepní prostory) se do základu daně **nezahrnují** — jsou-li podzemní prostory součástí celku, snižuje to základ daně oproti celkovým zastavěným plochám, jak by mohly být vnímány intuitivně.

Ke změnám skutečností v průběhu zdaňovacího období se nepřihlíží (§ 12c); rozhodující je vždy stav k 1. lednu.

#### Základ daně u zdanitelné jednotky — upravená podlahová plocha (odst. 3)

U jednotky se základ daně nestanovuje z plochy zastavěné, ale z **upravené podlahové plochy** — podlahová plocha se násobí koeficientem, který zohlední skutečnost, zda je do jednotky začleněn podíl na pozemku:

| Podmínka | Koeficient |
|---|---|
| Jednotka v bytovém domě + součástí je podíl na pozemku (nebo spoluvlastnictví jiného pozemku užívaného společně s jednotkami) | **1,22** |
| Ostatní případy | **1,20** |

Smyslem vyšší hodnoty koeficientu 1,22 je zohlednit, že součástí ocenitelné hodnoty jednotky je i hodnota pozemku — tím se přibližuje daňový základ skutečné ekonomické hodnotě nemovitosti. U jednotek bez pozemku (koeficient 1,20) se připouští, že hodnota pozemku není do základu zahrnuta.

#### Hierarchie pro zjištění podlahové plochy (odst. 4)

Zákon v odst. 4 zavádí trojstupňovou hierarchii:

1. **Katastr nemovitostí** — primárně; bez ohledu na shodu se skutečností (zásada formální publicity katastru pro daňové účely).
2. **Prohlášení vlastníka** — subsidiárně, pokud katastr plochu neeviduje; opět bez ohledu na skutečný stav.
3. **Skutečný stav** — teprve tehdy, není-li plocha v katastru ani v prohlášení.

Tato hierarchie chrání principy právní jistoty a předvídatelnosti; poplatník i správce daně vycházejí ze snadno dostupných a ověřitelných podkladů.

#### Vyloučení společných částí (odst. 5)
...
#### Systém skupin — klíč k sazbám

Zařazení do skupiny je přímým předpokladem pro aplikaci základní sazby daně dle § 11 odst. 1. Zákon rozlišuje **osm skupin**:

| Skupina | Písmeno odst. 1 |
|---|---|
| Obytné budovy | a) |
| Rekreační budovy | b) |
| Garáže | c) |
| Podnikání — zemědělská prvovýroba, lesní a vodní hospodářství | d) |
| Podnikání — průmysl, stavebnictví, doprava, energetika, ost. zeměd. výroba | e) |
| Podnikání — ostatní druhy podnikání | f) |
| Ostatní zdanitelné stavby | g) |
| Ostatní zdanitelné jednotky | h) |

#### Kritérium zařazení — převažující část podlahové plochy

Zařazení do skupiny se určuje podle **převažujícího účelu užívání** (nadpoloviční část podlahové plochy nadzemní části, resp. zastavěné plochy, resp. podlahové plochy jednotky). Při rovnosti podlahových ploch užívaných k různým účelům se u jednotky uplatní zásada zařazení do skupiny s **nejvyšší sazbou daně** (odst. 2 věta druhá).

#### Prioritní pravidlo pro podnikatele (odst. 3–4)

U staveb zařazených primárně do skupin a–c nebo g platí, že je-li jejich převažující část plochy užívána k podnikání, zařadí se do skupiny d–f. Obdobně platí pro garáže a ostatní jednotky (písm. c, h). Odst. 4 pak zakotvuje tvrdší pravidlo: stavba nebo jednotka zařazená v **obchodním majetku podnikatele** se vždy řadí do skupiny d–f, bez zkoumání faktického užívání — s výjimkami pro obytné budovy (a), garáže (c) a ostatní jednotky bez nebytového prostoru jiného než garáž, sklep nebo komora (h).
...
| Skupina / kategorie | Písmeno | Sazba (Kč/m²) |
|---|---|---|
| Budova obytného domu | a) | 3,50 |
| Jiná budova ve sk. obytných budov (nad 16 m²) | b) | 3,50 |
| Budova pro rodinnou rekreaci | c) | 11,00 |
| Jiná budova ve sk. rekreačních budov | d) | 3,50 |
| Garáže | e) | 14,50 |
| Podnikání — zeměd. prvovýroba, les., vodní hosp. | f) | 3,50 |
| Podnikání — průmysl, stavebnictví, doprava, energetika | g) | 18,00 |
| Podnikání — ostatní | h) | 18,00 |
| Ostatní zdanitelné stavby | i) | 11,00 |
| Ostatní zdanitelné jednotky | j) | 3,50 |

Anomálie v textu zdroje: § 11 odst. 1 je formátován jako jedna nepřerušená věta/tabulka bez odstavcového zalomení (v zákonném textu — sazby jsou uvedeny přímo za zkratkami skupin jako kompaktní blok). Komentář tuto strukturu věrně zobrazuje výše v tabulce.

Sazba u skupiny b) se uplatní pouze na plochu **přesahující 16 m²** zastavěné plochy — tzv. „příplatek za přesah". Tím je v principu tolerována existence menší vedlejší budovy jako příslušenství obytného domu (chata, kolna do 16 m²) bez daňového zatížení.

#### Zvýšení sazby za nadzemní podlaží (odst. 2–3)

Sazba základní se zvyšuje o **1,40 Kč/m²** za každé **další nadzemní podlaží** (tj. od druhého podlaží výše), pokud plocha tohoto podlaží přesahuje stanovený práh:

| Kategorie stavby | Práh plochy podlaží |
|---|---|
| Skupiny a–e, i (obytné, rekreační, garáže, ostatní) | Více než 2/3 zastavěné plochy |
| Skupiny f–h (podnikání) | Více než 1/3 zastavěné plochy |

Pro podnikatelské stavby je tedy podmínka mírnější — zvýšení sazby nastane již při nadpoloviční plné zastavěnosti podlaží (třetinový práh), což reflektuje vyšší intenzitu ekonomického využívání.

Definice v odst. 3 přesně určují:
- **První nadzemní podlaží** — konstrukční podlaží s podlahou do 0,80 m pod nejnižším bodem přilehlého terénu (není-li v projektové dokumentaci stanoveno jinak). Tím jsou za nadzemní podlaží považovány i „polozapuštěné" suterény překračující tento limit.
- **Další nadzemní podlaží** — každé podlaží nad prvním, včetně ustoupeného podlaží a účelově určeného podkroví.

#### Koeficient podle velikosti obce (odst. 4–5)

Zákonodárce zavedl systém koeficientů diferencujících sazbu podle počtu obyvatel obce. Koeficient se aplikuje **pouze na skupiny a), b) a j)** — tj. obytné budovy a ostatní zdanitelné jednotky:
...
| Nad 50 000 obyvatel, statutární města, Fr. Lázně, Luhačovice, Mariánské Lázně, Poděbrady | 3,5 |
| Praha | 4,5 |

Zákon výslovně jmenuje čtyři lázeňská města (Františkovy Lázně, Luhačovice, Mariánské Lázně, Poděbrady) v kategorii 3,5, ačkoli jejich počet obyvatel nedosahuje 50 000 — jedná se o tradiční legislativní zvláštnost odrážející specifické podmínky lázeňského bydlení a jeho vyšší hodnotu.

Obec může OZV koeficient **zvýšit o jednu kategorii** pro obytné budovy a ostatní jednotky na území jednotlivého katastrálního území, obvodu nebo části; koeficient 4,5 lze zvýšit na 5,0. Odpovídá to § 6 odst. 4 zákona u pozemků (srov. [01-casti1-2-obecna-dan-z-pozemku.md](01-casti1-2-obecna-dan-z-pozemku.md)).

#### Koeficient 2,0 pro chráněná území (odst. 6)
...
§ 11a řeší situaci, kdy budova obytného domu nebo zdanitelná jednotka sice jako celek zůstávají ve svých skupinách (obytné budovy, ostatní jednotky), ale část jejich ploch je fakticky využívána k podnikání. Bez tohoto ustanovení by mohlo docházet ke snížení daňové zátěže tím, že podnikatel primárně klasifikuje objekt jako obytný a těží z nižší sazby. Zákon proto zakotvuje **zvýšení daně** jako příplatek za podnikatelské využití.

#### Výpočet zvýšení — budova obytného domu (odst. 1)

Zvýšení = podlahová plocha nebytového prostoru (nebo místnosti pro ubytování) × 3,50 Kč/m².

Výjimky (zvýšení se neuplatní):
- Nebytový prostor je **osvobozenou** částí budovy.
- Podnikání v **zemědělské prvovýrobě, lesním nebo vodním hospodářství** (tyto aktivity jsou preferovány nižší základní sazbou).

#### Výpočet zvýšení — zdanitelná jednotka (odst. 2)

U jednotky je výpočet složitější — zvýšení se odvíjí od **rozdílu sazeb**: sazba příslušná pro podnikatelskou jednotku mínus sazba příslušná pro danou jednotku. Tím se zabrání tomu, aby zvýšení překročilo, co by poplatník zaplatil, kdyby byl celý objekt v podnikatelské skupině.

#### Omezení použití (odst. 3)
...
### § 11c — Daň z pozemků za výpočtový list
...
#### Algoritmus výpočtu daně z pozemků za výpočtový list

Zákon strukturuje výpočet do tří kroků:

**Krok 1 — Výchozí daň (odst. 1):**
> Výchozí daň = (součin základů daně × sazba − úhrn osvobození) × inflační koeficient

Každý mezivýsledek se zaokrouhluje na celé koruny nahoru. Tím jsou všechna zaokrouhlení vždy v neprospěch poplatníka, což je standardní daňová technika.

**Krok 2 — Spoluvlastnický podíl (odst. 2):**
Jsou-li na výpočtovém listu pozemky ve spoluvlastnictví, výchozí daň z odst. 1 se vynásobí výší spoluvlastnického podílu daného poplatníka. Každý spoluvlastník platí daň odpovídající svému podílu.

**Krok 3 — Místní koeficient (odst. 3):**
...
### § 11d — Daň ze staveb a jednotek za výpočtový list
...
#### Algoritmus výpočtu daně ze staveb a jednotek za výpočtový list

§ 11d obsahuje podrobnější, pětikrokový algoritmus oproti § 11c — odráží větší složitost zdanění staveb a jednotek (zvýšení daně, osvobození, inflační koeficient):

**Krok 1 — Výchozí daň před úpravami (odst. 1):**
> Výchozí daň před úpravami = úhrn základů daně × sazba

**Krok 2 — Výchozí daň před inflačním koeficientem (odst. 2):**
> Výchozí daň před IK = výchozí daň před úpravami + úhrn zvýšení daně (§ 11a) − úhrn nároků na osvobození

**Krok 3 — Výchozí daň za výpočtový list (odst. 3):**
> Výchozí daň za VL = výchozí daň před IK × inflační koeficient (§ 11f, část pátá)

**Krok 4 — Spoluvlastnický podíl (odst. 4):**
Jsou-li na výpočtovém listu nemovitosti ve spoluvlastnictví, výchozí daň se vynásobí výší spoluvlastnického podílu.

**Krok 5 — Místní koeficient (odst. 5):**
> Daň ze staveb a jednotek za VL = výchozí daň za VL × místní koeficient (§ 12)

#### Vzájemná provázanost s jinými ustanoveními

Algoritmus se opírá o:
- Základní sazby a koeficienty dle §§ 11, 10a (skupiny a sazby).
- Zvýšení daně dle § 11a (nebytové prostory v obytných budovách).
- Osvobození dle § 9.
...
#### Celková daň z nemovitých věcí

§ 11e uzavírá výpočtový algoritmus zákona č. 338/1992 Sb. jako celek. Celková **daň z nemovitých věcí** se skládá ze dvou složek:

1. **Daň z pozemků** — součet daní z pozemků za všechny výpočtové listy poplatníka v obvodu jednoho správce daně.
2. **Daň ze staveb a jednotek** — součet daní ze staveb a jednotek za všechny výpočtové listy téhož poplatníka.

Tato finální agregace je záměrně jednoduchá — veškerá výpočtová komplikovanost byla absorbována v §§ 11c a 11d. Výsledná daň z nemovitých věcí je pak základem pro:
